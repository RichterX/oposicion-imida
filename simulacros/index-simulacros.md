# Indice general de simulacros

Este indice reune todos los simulacros disponibles, organizados por bloques.

## Bloque 01 - Administracion de sistemas

- [Simulacro 01](bloque-01/simulacro-01.md)
- [Plantilla simulacro 01](bloque-01/plantilla-simulacro-01.md)
- Correcciones por partes:
- [Correccion parte 1](bloque-01/correccion-simulacro-parte-1.md)
- [Correccion parte 2](bloque-01/correccion-simulacro-parte-2.md)
- [Correccion parte 3](bloque-01/correccion-simulacro-parte-3.md)

## Bloque 02 - Redes

- [Simulacro 02](bloque-02/simulacro-02.md)
- [Plantilla simulacro 02](bloque-02/plantilla-simulacro-02.md)
- Correcciones por partes:
- [Correccion parte 1](bloque-02/correccion-simulacro-2-parte-1.md)
- [Correccion parte 2](bloque-02/correccion-simulacro-2-parte-2.md)
